...
public interface AtlasDSLParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AtlasDSLParser#hasRClause}.
	 * @param ctx the parse tree
	 */
	void enterHasRClause(AtlasDSLParser.HasRClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link AtlasDSLParser#hasRClause}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link AtlasDSLParser#hasRExpression}.
	 * @param ctx the parse tree
	 */
	void enterHasRExpression(AtlasDSLParser.HasRExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link AtlasDSLParser#hasRExpression}.
	 * @param ctx the parse tree
	 */
	void exitHasRExpression(AtlasDSLParser.HasRExpressionContext ctx);
	/**
