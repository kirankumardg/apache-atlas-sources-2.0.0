...
public class AtlasStructType extends AtlasType {
    ...
    public static class AtlasAttribute {
        ...
        private static char[] IDX_QRY_OFFENDING_CHARS = { '@', '/', ' ', '-' };
        ...
        static {
            try {
                ...
                String str = config.getString("atlas.special.characters");
                if(str != null) {
                    IDX_QRY_OFFENDING_CHARS = str.toCharArray();
                }
                LOG.info("atlas.special.characters {}", new String(IDX_QRY_OFFENDING_CHARS));
